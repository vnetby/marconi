<?php
namespace BaristaEdge\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface {
		...
		vc_map( array(
				...
				'params' => array(
					array(
						...
						"param_name" => "text",
						"value" => esc_html__("Blockquote text", 'edge-cpt'),
						"save_always" => true
					),
					array(
						"type" => "textfield",
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_shortcode_template_part('templates/blockquote-template', 'blockquote', '', $params);
