 ...
 */
if (!class_exists('BaristaEdgeStickyNavigationWalker')) {
	class BaristaEdgeStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			//menu type class
			$wide_background = '';
			if(barista_edge_options()->getOptionValue('enable_wide_manu_background') == "yes" ){
