...
/*
  Class: BaristaEdgeIconCollections
...
class BaristaEdgeIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection( 'font_awesome', new BaristaEdgeIconsFontAwesome( "Font Awesome", "fa_icon" ) );
		$this->addIconCollection( 'font_elegant', new BaristaEdgeIconsFontElegant( "Font Elegant", "fe_icon" ) );
		$this->addIconCollection( 'ico_moon', new BaristaEdgeIcoMoonIcons( 'Ico Moon', 'ico_moon' ) );
		$this->addIconCollection( 'ion_icons', new BaristaEdgeIonIcons( "Ion Icons", "ion_icon" ) );
		$this->addIconCollection( 'linea_icons', new BaristaEdgeLineaIcons( 'Linea Icons', 'linea_icon' ) );
		$this->addIconCollection( 'linear_icons', new BaristaEdgeLinearIcons( 'Linear Icons', 'linear_icons' ) );
		$this->addIconCollection( 'simple_line_icons', new BaristaEdgeSimpleLineIcons( 'Simple Line Icons', 'simple_line_icons' ) );
		$this->addIconCollection( 'dripicons', new BaristaEdgeDripicons( 'Dripicons', 'dripicon' ) );
	...
	public function getIconCollectionIcons( iBaristaEdgeIconCollection $collection ) {
	...
	public function enqueueStyles() {
		if ( is_array( $this->iconCollections ) && count( $this->iconCollections ) ) {
			foreach ( $this->iconCollections as $collection_key => $collection_obj ) {
				wp_enqueue_style( 'barista-edge-' . $collection_key, $collection_obj->styleUrl );
			}
		}
	}
	...
	public function getSearchIcon( $iconPack, $return ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			if ( $return ) {
				...
				print barista_edge_get_module_part( $iconsObject->getSearchIcon() );
			}
	...
	public function getSearchClose( $iconPack, $return ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			if ( $return ) {
				...
				print barista_edge_get_module_part( $iconsObject->getSearchClose() );
			}
	...
	public function getSearchIconValue( $iconPack ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			$iconsObject = $this->getIconCollection( $iconPack );
			print barista_edge_get_module_part( $iconsObject->getSearchIconValue() );
	...
	public function getMenuSideIcon( $iconPack ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			$iconsObject = $this->getIconCollection( $iconPack );
			print barista_edge_get_module_part( $iconsObject->getMenuSideIcon() );
	...
	public function getBackToTopIcon( $iconPack ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			$iconsObject = $this->getIconCollection( $iconPack );
			print barista_edge_get_module_part( $iconsObject->getBackToTopIcon() );
	...
	public function getMobileMenuIcon( $iconPack, $return = false ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			if ( $return ) {
				...
				print barista_edge_get_module_part( $iconsObject->getMobileMenuIcon() );
			}
		}
	...
	public function getQuoteIcon( $iconPack, $return = false ) {
		...
		if ( $this->hasIconCollection( $iconPack ) ) {
			...
			if ( $return == true ) {
				...
				print barista_edge_get_module_part( $iconsObject->getQuoteIcon() );
			}
...
$barista_edge_IconCollections = BaristaEdgeIconCollections::get_instance();