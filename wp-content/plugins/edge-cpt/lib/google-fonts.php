<?php
if ( ! function_exists( 'barista_edge_init_google_fonts_array' ) ) {
    function barista_edge_init_google_fonts_array() {
        ...
        $barista_edge_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'barista_edge_init_google_fonts_array');
}