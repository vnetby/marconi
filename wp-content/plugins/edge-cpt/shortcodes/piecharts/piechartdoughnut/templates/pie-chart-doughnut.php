<div class="edgtf-pie-chart-doughnut-holder">
	<div class="edgtf-pie-chart-doughnut">
		<canvas id="pie<?php echo esc_attr($id); ?>" class="edgtf-doughnut" height="<?php echo esc_html($height); ?>" width="<?php echo esc_html($width); ?>" <?php echo barista_edge_get_inline_attrs($pie_chart_data)?>></canvas>
	</div>
