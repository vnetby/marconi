...
define('EDGE_FRAMEWORK_ADMIN_ASSETS_ROOT', get_template_directory_uri().'/framework/admin');
define('EDGE_FRAMEWORK_ADMIN_ASSETS_ROOT_DIR', get_template_directory().'/framework/admin');
