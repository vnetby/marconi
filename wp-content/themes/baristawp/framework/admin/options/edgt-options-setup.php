...
add_action('after_setup_theme', 'barista_edge_admin_map_init', 0);

function barista_edge_admin_map_init() {

    do_action('barista_edge_before_options_map');
    ...
    require_once EDGE_FRAMEWORK_ROOT_DIR.'/admin/options/cafe/map.php';
    ...
    do_action('barista_edge_options_map');

    do_action('barista_edge_after_options_map');
