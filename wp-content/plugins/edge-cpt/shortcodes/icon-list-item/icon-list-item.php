<?php
namespace BaristaEdge\Modules\Shortcodes\IconListItem;
...
class IconListItem implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_shortcode_template_part('templates/icon-list-item-template', 'icon-list-item', '', $params);
		return $html;
	}
	 /**
	...
	private function getIconStyle($params){
		...
		if (!empty($params['icon_size'])) {
			$iconStylesArray[] = 'font-size:' .barista_edge_filter_px( $params['icon_size']) . 'px';
		}
	...
	private function getTitleStyle($params){
		...
		if (!empty($params['title_size'])) {
			$titleStylesArray[] = 'font-size:' .barista_edge_filter_px( $params['title_size']) . 'px';
		}

		if (!empty($params['font_weight'])) {
			$titleStylesArray[] = 'font-weight:' .barista_edge_filter_px( $params['font_weight']);
		}
