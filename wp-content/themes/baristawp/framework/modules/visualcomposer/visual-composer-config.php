...
if ( ! function_exists('barista_edge_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function barista_edge_configure_visual_composer() {
	...
	add_action('vc_after_init', 'barista_edge_configure_visual_composer');

}


if ( ! function_exists('barista_edge_configure_visual_composer_grid_elemets') ) {
	...
	function barista_edge_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'barista_edge_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('barista_edge_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function barista_edge_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'barista_edge_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if ( ! function_exists('barista_edge_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function barista_edge_vc_row_map()
	{
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => 'Enable Lighter Effect on Row',
		...
		vc_add_param('vc_row', array(
			'type' => 'colorpicker',
			'heading' => 'Lighter Effect Background',
	...
	add_action('vc_after_init', 'barista_edge_vc_row_map');
}
