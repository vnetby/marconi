<?php
namespace BaristaEdge\Modules\Shortcodes\ShopMasonry;
...
class ShopMasonry implements ShortcodeInterface
{
    ...
    {
        vc_map(array(
            'name' => esc_html__('Shop Masonry','edge-cpt'),
            'base' => $this->base,
            ...
            'params' => array(
                ...
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Show Category Filter','edge-cpt'),
                    'param_name' => 'filter',
                    'value' => array(
    ...
    public function render($atts, $content = null)
    {
        ...
        if($filter == 'yes'){
            ...
            $html .= edge_core_get_shortcode_template_part('templates/shop-filter','shop-masonry', '', $params);
        }
        ...
        if ( $products->have_posts() ) :
            ...
            while ( $products->have_posts() ) : $products->the_post();
                ...
                $html .= edge_core_get_shortcode_template_part('templates/shop-masonry-template','shop-masonry','',$params);
