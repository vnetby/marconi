...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity edgtf-quantity-buttons">
		...
		<input 
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'baristawp' ) ?>" 
			size="4" 
			pattern="<?php echo esc_attr( $pattern ); ?>" 
			inputmode="<?php echo esc_attr( $inputmode ); ?>" 
			aria-labelledby="<?php echo ! empty( $args['product_name'] ) ? sprintf( esc_attr__( '%s quantity', 'baristawp' ), $args['product_name'] ) : ''; ?>" />
